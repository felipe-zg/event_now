...
<tags:pageTemplate titulo="Cadastro de evento" bodyClass="bg-dark">
	<div class="container">
		<form action="/sinqia/evento/cadastrar" method="POST">
			<div class="form-group">
				<label class="text-light">Nome do evento</label>
				<input type="text" path="nome" name="nome" class="form-control" required="true"/>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" path="valor" name="valor" class="form-control" />
			</div>
			<div class="form-group">
				<label class="text-light">Data do evento</label>
				<input type="text" placeholder="dd/mm/aaaa" path="data" name="data" class="form-control" />
			</div>
			<div class="form-group">
				<label class="text-light">Horario do evento</label>
				<input type="text" placeholder="hh:mm" name="hora" class="form-control" />
			</div>
		...
		<div>
			<a href="/sinqia/empresa/enderecoAlternativo">
				<button type="submit" class="btn btn-sm btn-outline-warning " style="margin-top:10px;">Adicionar outro endeeco</button>
			</a>
		</div>
	</div>
</tags:pageTemplate>
